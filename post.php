        ...
        <div class="row">
            ...
            <div class="col-md-8">
              ...
              <?php
                ...
                // Update viewcount
                $query = "UPDATE posts SET postViews = postViews + 1 WHERE postid = {$pid};";
              ...
              ?>
                ...
                <p class="lead">
                    by <a href="author-posts.php?author=<?php echo $postAuthor; ?>&pid=<?php echo $pid; ?>"><?php echo $postAuthor; ?></a>
                </p>
